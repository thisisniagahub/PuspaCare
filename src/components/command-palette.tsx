...
const VIEW_ITEMS: { id: ViewId; label: string; keywords: string[] }[] = [
  ...
  { id: 'openclaw-mcp', label: 'Pelayan MCP', keywords: ['mcp', 'server', 'openclaw', 'ai ops'] },
  { id: 'openclaw-plugins', label: 'Sambungan AI', keywords: ['plugin', 'sambungan', 'openclaw', 'ai ops'] },
  { id: 'openclaw-integrations', label: 'Gateway & Channel', keywords: ['integrasi', 'integration', 'gateway', 'channel', 'openclaw'] },
  { id: 'openclaw-terminal', label: 'Console Operator', keywords: ['terminal', 'console', 'operator', 'openclaw'] },
  { id: 'openclaw-agents', label: 'Ejen AI', keywords: ['agent', 'ejen', 'ai', 'openclaw'] },
  { id: 'openclaw-models', label: 'Enjin Model', keywords: ['model', 'llm', 'engine', 'openclaw'] },
  { id: 'openclaw-automation', label: 'Automasi Latar', keywords: ['automasi', 'automation', 'cron', 'openclaw'] },
